...
void api_GetAnalyzeSignal(u8 led);
void api_JudgeSignal(u8 led);
void api_GetAnalyzeBuzzSignal(u8 led);
void api_JudgeBuzzSignal(u8 led);
u8 api_GetGuideFlag(u8 led);
u16 api_GetLedTimeFlag(u8 led);
...
void api_MachinePowerOn(void)
{
	...
	while(1)
	{
		if(api_GetSystemTimePeriod(mMaininf.mSystem.mPowerOnStartTime) > 5000)
		{
			...
			{
				if((GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11) == GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)))
				{
 ...
 * @retvalue   :None
******************************************************************************/
u8 api_GetAnalyzePeriod(u16 mValue,u16 ParamMin,u16 ParamMax)
{
	return (((mValue >= ParamMin) && (mValue <= ParamMax)) ? 1 : 0 );
}

/*****************************************************************************
 * @name       :void api_GetAnalyzeSignal(u8 led)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :解析信号
 * @parameters :LED灯
...
void api_GetAnalyzeSignal(u8 led)
{
//	asd = mMaininf.mWork.mWorkBurnLed[led].mTimeContLast;
	mMaininf.mWork.mWorkBurnLed[led].mTimePeriod = 1500 - mMaininf.mWork.mWorkBurnLed[led].mTimeContLast;
	
	if(api_GetAnalyzePeriod(mMaininf.mWork.mWorkBurnLed[led].mTimePeriod,600,800) == 1)
	{
		mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag = 1;//成功波形
	}
	if(api_GetAnalyzePeriod(mMaininf.mWork.mWorkBurnLed[led].mTimePeriod,1100,1300) == 1)
	{
		mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag = 2;//失败波形
	}
	
	mMaininf.mWork.mWorkBurnLed[led].mTimeContLast = 1500;
	mMaininf.mWork.mWorkBurnLed[led].mTimeContTime = 2000;
}

/*****************************************************************************
 * @name       :void api_JudgeSignal(u8 led)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :解析信号
 * @parameters :LED灯
...
void api_JudgeSignal(u8 led)
{
	if(mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag == 1)
	{
		mMaininf.mWork.mWorkBurnLed[led].mCountDownFlag = 1;
	}
	else if(mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag == 2)
	{
		mMaininf.mWork.mWorkBurnLed[led].mCountDownFlag = 2;
	}
	
	mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag = 0;
	
	mMaininf.mWork.mWorkBurnLed[led].mCountDownTime = 1500;
}
...
{
// 	jjjjj++;
	mMaininf.mWork.mWorkBurnLed[led].mTimePeriod = 2000 - mMaininf.mWork.mWorkBurnLed[led].mTimeContLast;
	
// 	if(jjjjj >= 2)
// 	{
// 		jjjjj = 0;
// 	}
	if(api_GetAnalyzePeriod(mMaininf.mWork.mWorkBurnLed[led].mTimePeriod,500,1000) == 1)
	{
		mMaininf.mWork.mWorkBurnLed[led].mReceiveOkFlag = 1;
	}
	
	mMaininf.mWork.mWorkBurnLed[led].mTimeContLast = 2000;
}
...
void api_JudgeBuzzSignal(u8 led)
{
	...
	mMaininf.mWork.mWorkBurnLed[led].mCountDownFlag = 1;
	mMaininf.mWork.mWorkBurnLed[led].mCountDownTime = 3000;
}

/*****************************************************************************
 * @name       :u8 api_GetGuideFlag(u8 led)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :判断信号状态
 * @parameters :相应
...
u8 api_GetGuideFlag(u8 led)
{
	return mMaininf.mWork.mWorkBurnLed[led].mCountDownFlag;
}

/*****************************************************************************
 * @name       :u16 api_GetLedTimeFlag(u8 led)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :判断信号状态
 * @parameters :相应
...
u16 api_GetLedTimeFlag(u8 led)
{
	return mMaininf.mWork.mWorkBurnLed[led].mTimeContTime;
}
