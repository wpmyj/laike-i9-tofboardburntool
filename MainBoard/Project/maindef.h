...
typedef struct _ST_SYSTEM_MANAGER{
	...
	u32 mLedDoubleFlashStartTime;
	
	u32 mKeyDelayStartTime;
}_ST_SYSTEM_MANAGER;
...
typedef struct _ST_WORK_MANAGER{
	...
	_BURN_LED mWorkBurnLed[3];
	u8 mWorkBurnReceiveFlag : 1;
	
	u8 mWorkFirstLedFlag : 1;
}_ST_WORK_MANAGER;
