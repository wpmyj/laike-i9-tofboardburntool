...
void GPIO_Configure(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_15;//输入
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 	GPIO_Init(GPIOA, &GPIO_InitStructure);
	...
	/* Connect EXTI12 Line to PA.12 pin */
...
// 	mMaininf.mSystem.mSystem10usTick = 0;
	...
	mMaininf.mSystem.mBurnStartTime = 0;
	
	mMaininf.mSystem.mLedDoubleFlashStartTime = 0;
	mMaininf.mSystem.mKeyDelayStartTime = 0;
...
// 	mMaininf.mUart5.mReceiveFlag = 0;      //    没有接收导数据
	memset(&mMaininf.mWork.mWorkBurnLed[0], 0, sizeof(mMaininf.mWork.mWorkBurnLed[0]));
	memset(&mMaininf.mWork.mWorkBurnLed[1], 0, sizeof(mMaininf.mWork.mWorkBurnLed[1]));
	memset(&mMaininf.mWork.mWorkBurnLed[2], 0, sizeof(mMaininf.mWork.mWorkBurnLed[2]));
// 	memset((void*)&mMaininf.mWork.mWorkBurnLed[0], 0x00, sizeof(mMaininf.mWork.mWorkBurnLed[0]));
	...
	mMaininf.mWork.mWorkBurnReceiveFlag = 0;
